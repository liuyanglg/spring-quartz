...
public class RSAUtil {
	...
	public static String encrypt(String s, String publicKey) throws Exception {
		...
		return Base64.encodeBase64URLSafeString(cipher.doFinal(s.getBytes(CHARACTER_ENCODEING)));
	}
	 ...
	 * @throws Exception
	 */
	public static String decryptByPrivateKey(String src, String privateKey) throws Exception {
		byte[] keyBytes = Base64.decodeBase64(privateKey);
		PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
		KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
	 ...
	 * @throws Exception
	 */
	public static String decryptByPublicKey(String src, String publicKey) throws Exception {
		byte[] keyBytes = Base64.decodeBase64(publicKey);
	 ...
	 * @throws Exception
	 */
	public static String encryptByPublicKey(String src, String publicKey) throws Exception {
